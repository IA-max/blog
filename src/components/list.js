...
export default (post) => {
    return (<li className="flex py-2" key={post.fields.slug}>
            ...
            {
                    post.frontmatter.featured && (<span className="ml-auto inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest"><svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" class="w-4 h-4 text-indigo-500" viewBox="0 0 24 24">
