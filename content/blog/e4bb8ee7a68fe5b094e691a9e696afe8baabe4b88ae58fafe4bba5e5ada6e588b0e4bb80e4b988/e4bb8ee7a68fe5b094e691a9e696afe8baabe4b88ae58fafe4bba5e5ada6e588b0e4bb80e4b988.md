...
<figure class="wp-block-image">![](https://blog.imaxyoung.com/wp-content/uploads/2019/09/image.jpeg)</figure>我们可以互换角色来看一下这些侦察步骤可以教我们如何做良好的用户体验研究。
...
<figure class="wp-block-image">![](https://blog.imaxyoung.com/wp-content/uploads/2019/09/image-1.jpeg)</figure>我们的假设，现在能帮助我们识别人们工作的不同方式。当我们对做过的事情和将来可能会做的事情进行比较的时候，这么做的重要性就体现出来了。为了我们创新和设计团队发现这些不同，在我们工作的进程中必须充分的回答关于用户、任务、使用环境的问题。（谁？做什么？在什么情况下？）我们的模型、角色、场景和故事应包括：
...
<figure class="wp-block-image">![](https://blog.imaxyoung.com/wp-content/uploads/2019/09/image-2.jpeg)</figure>下面是一些可以确保设计团队对你的调查结果采取行动的建议：
