...
featured: false
category: "css"
excerpt: "本文总结了各种常见的布局实现，并给出每个方法的优缺点分析，作为一个CSS知识整理."
tag: ["css","layout"]
status: "publish"
type: "post"
cover: "./none.png"
...
效果图：（就搭个大概，滚动条可以自己优化）![image.png](./28.png)
...
![1529545198369.png](./24.png)

收缩效果图：

![1529545209218.png](./25.png)
...
### 参考链接:
[css layout](https://github.com/Sweet-KK/css-layout)